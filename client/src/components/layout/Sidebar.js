...
import { FaHome, FaChartBar, FaTractor, FaSignOutAlt, FaChevronLeft, FaChevronRight, FaLeaf } from "react-icons/fa"
...
const Sidebar = ({ isOpen, onToggle, userModules = [], userRole = "user", hasModuleAccess, isAdmin }) => {
